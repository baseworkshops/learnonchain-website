        ...
        >
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-blue-400 to-teal-400 relative z-10">
              Shaping the Future of Onchain Education
            </h1>
          </motion.div>
          ...
          >
            Discover our journey and plans to empower communities worldwide
          </motion.p>
          ...
          >
            ...
            >
              <span className="relative z-10">Explore Our Roadmap</span>
