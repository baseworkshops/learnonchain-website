        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="relative bg-white/5 backdrop-blur-md rounded-lg p-12 md:p-16 border border-white/10 group-hover:border-white/20 transition-all duration-300 text-center">
              ...
              >
                Be a part of the onchain revolution. Together, we can build a better digital future.
              </motion.p>
              ...
              >
                ...
                >
                  Get Involved
                  <Users className="ml-2 w-5 h-5 transition-transform group-hover/button:scale-110" />
                </Button>
                <Button
                  size="lg"
                  variant="outline"
