        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="relative bg-white/5 backdrop-blur-md rounded-lg p-12 md:p-16 border border-white/10 group-hover:border-white/20 transition-all duration-300 text-center">
              ...
              >
                Join our community and stay updated on the latest from LearnOnchain
              </motion.p>
              ...
              >
                ...
                >
                  Join Our Discord
                  <MessageCircle className="ml-2 w-5 h-5 transition-transform group-hover/button:scale-110" />
                </Button>
                <Button
                  size="lg"
                  variant="outline"
                ...
                >
                  ...
                  <Twitter className="ml-2 w-5 h-5 transition-transform group-hover/button:translate-x-1" />
                </Button>
              </motion.div>
            </div>
          </motion.div>
